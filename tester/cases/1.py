...
"""
this script is used to test + and - operator
"""
...
sourc_python.close()
system("chmod +x /tmp/1.py")
system("/tmp/1.py > /tmp/1_python.out")

exit(system("diff -b -B -u /tmp/1_cpp.out /tmp/1_python.out > /tmp/1.diff")//256)